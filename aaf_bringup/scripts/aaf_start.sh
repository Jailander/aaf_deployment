...
tmux send-keys "DISPLAY=:0 roslaunch aaf_bringup aaf_navigation.launch map:=/opt/strands/maps/WW_lab_2016_09_09-cropped.yaml topological_map:=WW_2016_09_28"
